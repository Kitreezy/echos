...
echos/
  ...
  Views/           UIKit-экраны и SwiftUI-списки; палитра и черновик
                   мозаики, баннер о входящем
  Services/
  ...
  Utilities/       AsyncBroadcast, настройки
...
- Мозаика: рисунок из эмодзи на сетке, который у собеседника не разъезжается. Рисуется прямо в чате, палитра вместо клавиатуры; начатое не пропадает
- Текст выделяется прямо в ленте, ссылки живые; неотправленное повторяется нажатием
- Входящее не в открытый чат — баннером сверху на любом экране и числом в списке разговоров
...
- Уведомления на экране блокировки, пока приложение живо в фоне — локальные, без пушей: сервер о содержимом не знает, и слать ему нечего
