...
echos/
├── Models/
│   ├── Message.swift          ← модель сообщения + Codable payload
│   └── Peer.swift             ← модель устройства
├── ViewModels/
│   └── ChatViewModel.swift    ← @Observable + async/await
└── Views/
    ├── ChatViewController.swift  ← UIKit экран чата
    └── MessageCell.swift         ← bubble-ячейка
...
<p align="center">
  <strong>Статус MVP:</strong> в разработке · День 1 / 25+
</p>
