...
```
echos/
  Models/          сообщение, собеседник, росчерк, события набора
  ViewModels/      ChatViewModel, WallViewModel — @Observable, async/await
  Views/           UIKit-экраны и SwiftUI-списки
  Services/
...
- Мозаика: рисунок из эмодзи на сетке, который у собеседника не разъезжается
